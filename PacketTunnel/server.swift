...
//  Provider-iOS
//
//  Created by k17101kk on 2021/12/07.
//
...
private final class VPNDatagramHandler: ChannelInboundHandler {
    ...
    public func channelRead(context: ChannelHandlerContext, data: NIOAny) {
        var inputEnvelope = unwrapInboundIn(data)
        let inputData = Data(inputEnvelope.data.readableBytesView) // TODO: this probably isn't optima
//        let buff = inputEnvelope.data.readSlice(length: 76)
        print("length ",inputData)
        print("inputData ",data)
        //print("Data ",buff as Any)
        //print("inputData ",data.storage)
        print("receive data:", inputEnvelope.data.getBytes(at: 0, length:50))
        //print("NIOAnyData ", NIOAny(data))
        
        
        do {
            
            let code = try PacketCode(datagram: inputData)
//            print("Code ",inputData[0])
            print("Code ")
            switch code {
...
//let arg1 = "0.0.0.0"//arguments.dropFirst().first
//let arg2 = 9999//arguments.dropFirst().dropFirst().first

#warning("TEMP:")
//let defaultHost = "::1"
let defaultHost = "10.0.2.225"
let defaultPort = 10001
...
bindTarget = .ip(host: "10.0.2.225", port: 10000)
